...
public class Service {
    ...
    public static String getResult(HttpServletRequest req) {
    ...
    private static String parsingExpression(String expression, Map<String, String[]> parameter) {
    ...
    private static List<String> processingExpression(String mathExpression) {
    ...
    private static String[] overwriting(String[] arrStr, int position) {
